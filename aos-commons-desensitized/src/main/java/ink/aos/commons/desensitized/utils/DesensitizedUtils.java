package ink.aos.commons.desensitized.utils;
...
public class DesensitizedUtils {
    ...
    public static String carNumber(String carNumber) {
        ...
        return StringUtils.left(carNumber, 2).concat(StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(carNumber, 1), StringUtils.length(carNumber), "*"), "**"));
    }
